...
Status: current · Scope: `apps/api/src/submissions` · Parent: `../../../README.md` · Owns: upload flow, group credit, scoring, review
...
sequenceDiagram
  ...
  P->>A: POST /submissions/upload-url {challenge_id, content_type, size}
  ...
  P->>A: POST /submissions {challenge_id, path, member_ids, caption, lat, lng}
